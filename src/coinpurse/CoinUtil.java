...
public class CoinUtil {
	...
	public static List<Coin> filterByCurrency(final List<Coin> coinlist, String currency) {
		List<Coin> newlist = new ArrayList<Coin>();
		if (currency != null) {
			for (Coin coin : coinlist) {
				if (coin.getCurrency().equals(currency)) newlist.add(coin);
			}
		}
		return newlist; // return a list of coin references copied from coinlist
	}
	...
	static class CompareByCurrency implements Comparator<Coin> {
		public int compare(Coin other1 , Coin other2) {
